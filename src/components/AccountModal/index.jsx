		...
		<Container>
			...
			{connectorData && (
				<>
					...
					<Connector>
						<img src={require('../../assets/images/wallets/' + connectorData.icon).default} />
			...
			<InputContainer>
				<Input value={account} readonly spellCheck={false} autoComplete={false} />
			...
			<DisconnectButton onClick={disconnectWallet}>Disconnect wallet <i className='fad fa-sign-out' /></DisconnectButton>
		</Container>
	)
}
